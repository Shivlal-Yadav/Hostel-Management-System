...
public class AllSalary extends JFrame
{
    ...
    public static void main(final String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    final AllSalary frame = new AllSalary();
    ...
    public AllSalary() {
        ...
        final String[] colNames = { "Eid", "Name", "Salary", "Paid", "Balance" };
